...
func TestSQLiteStore_WriteReadRelationship(t *testing.T) {
	store, cleanup := setupTestStore(t)
	defer cleanup()
...
func TestSQLiteStore_TraverseGraph(t *testing.T) {
	store, cleanup := setupTestStore(t)
	defer cleanup()
...
func TestSQLiteStore_TraverseGraphWithPredicateFilter(t *testing.T) {
	store, cleanup := setupTestStore(t)
	defer cleanup()
